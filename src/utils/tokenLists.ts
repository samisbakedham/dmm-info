 ...
 */
export default async function getTokenList(listUrl: string, networkInfo): Promise<TokenList> {
  ...
  for (let i = 0; i < urls.length; i++) {
    ...
    if ([137, 56, 43114, 250, 25, ChainId.ARBITRUM, ChainId.BTTC].includes(networkInfo.CHAIN_ID)) {
      return json
    }
