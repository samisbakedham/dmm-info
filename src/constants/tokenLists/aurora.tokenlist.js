...
const AURORA_TOKEN_LIST = AURORA_TOKEN_LIST_ARRAY.reduce((acc, cur) => {
  const checksummedAddress = isAddress(cur.address)

  return checksummedAddress
    ? {
        ...acc,
        [checksummedAddress]: { ...cur, address: checksummedAddress },
      }
    : {
        ...acc,
        [cur.address]: cur,
...
export default AURORA_TOKEN_LIST
